...
!                                                                      !
!  Update to SI units         cgw                           09-Nov-21  !
!  Comments: Write reaction rates in units of kmol/sec.m^3 (SI).       !
!                                                                      !
...
! Molar concentration of solids species (kmol/m^3)
...
! Compute concentration of moisture (kmol/m^3)
      c_Moisture = ROP_s(IJK,1)*X_s(IJK,1,Moisture)/MW_s(1,Moisture)

! Compute concentration of carbon (kmol/m^3)
