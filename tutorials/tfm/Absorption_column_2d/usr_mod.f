...
! critical surface tension of packing (surface energy) in N/m
...
! water. This is returned in units of N/m (kg/s^2)                     !
!                                                                      !
...
! water. This is returned in units of W/(m.K)                          !
!                                                                      !
! This work appears to be based entirely on water and MEA (no other    !
...
! solution. The density of solution is returned in units of kg/m^3     !
!                                                                      !
!                                                                      !
...
!     -concentration from 43 to 5016 kmol/m^3                          !
!                                                                      !
! References:                                                          !
...
! temperature. The Henry's law constant is returned in Pa.m^3/kmol     !
!                                                                      !
! References:                                                          !
! Hiwale, R., et al., IECR, 2012, 51, 4328-4346.                       !
!   equations 2, 3, 4, 5.                                              !
...
! Convert to the necessary units.
      calc_H_CO2inMEA = USR_C(1)*10.0d0*(100.d0*100.d0*100.d0)* &
                   H_CO2inMEA ! (barye*cm^3/mol)

      IF (UNITS=='SI') calc_H_CO2inMEA=usr_c(1)*1000.d0*H_CO2inMEA  !(Pa.m^3/kmol)
...
! returned in units of (m^3/s.kmol).                                   !
...
! Liquid superficial mass velocity (kg/m^2.s)
