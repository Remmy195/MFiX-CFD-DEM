...
from mfixgui.tools import is_vnc, SCRIPT_DIR, replace_with_dict, case_insensitive
...
class MockParent(QtWidgets.QWidget):
    signal_stderr = Signal(object)
    signal_stdout = Signal(object)
...
class NodeworksRunPopup(RunPopup):
    def __init__(self, mfix_exe, parent):
        ...
        # tweak the dialog
        self.ui.button_restart_0.hide()
        self.ui.button_restart_1.hide()
        self.ui.button_restart_2.hide()
...
class NodeworksWidget(QtWidgets.QWidget):
    def __init__(self, project, parent=None):
        ...
        nl = self.nodeChart.nodeLibrary
        if hasattr(nl, 'buildDefaultLibrary'):
            nl.buildDefaultLibrary()
        elif hasattr(nl, 'build_default_library'):
            nl.build_default_library()
        ...
        self.job_status_table.set_value({})
        ...
        self.job_status_table.default_value = {}
    ...
    def _run(self, proj_dir, mfx_file):
        ...
        # local
            ...
            if self.local_queue:
                ...
                parent.settings = SETTINGS
                parent.signal_stderr.connect(self.job_error)
    ...
    def submit_to_queue(self, project_dir, rcmd):
        ...
        # submit the job
        self.mfixgui.print_internal("Job submit command: {}".format(cmd),
                                    color='blue')
    ...
    def create_job_manager(self, proj_dir):
        ...
        if pid_files:
            ...
            job.try_connect(full_run_name_pid)
