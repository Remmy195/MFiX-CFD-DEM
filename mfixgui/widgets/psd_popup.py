...
class PSDPopup(QDialog):
    ...
    def set_ok_button(self, state, msg=''):
        ...
        self.ui.label_status.setStyleSheet("color: %s" % ("green" if state else "red"))
...
...                    <i>additional data lines</i>
    ...
    def select_file(self):
        ...
        if (fname
            ...
            and not shutil._samefile(os.path.dirname(fname), os.getcwd())): # Not in current directory
    ...
    def plot_psd(self):
        ...
        custom = False
        type_ = None
        pdf = μ_star = mode = skew = None # pylint
        ...
        if hasattr(fig, 'execute_constrained_layout'):
            fig.execute_constrained_layout()
        elif hasattr(fig, 'set_layout_engine'):
