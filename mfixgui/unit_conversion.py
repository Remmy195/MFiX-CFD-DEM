...
cgs_to_SI = {
  ...
  'cg_ur_fac':      1,    # factor                 : Underrelaxation factor used in cut cells (only CG_UR_FAC(2)
  ...
  'flux_g':         10,   # g/cm^2.s -> kg/m^2.s   : If a value is specified, the domain-averaged gas flux is
  ...
  'max_inlet_vel_fac': 1, # factor                 : The code declares divergence if the velocity anywhere in the
  ...
  'ur_fac':         1,    # factor                 : Underrelaxation factors.
  'ur_kth_sml':     1,    # factor                 : Underrelaxation factor for conductivity coefficient
  'usr_c':          None, # UNKNOWN                : User defined constants.
    ...
    for key in dp_keys:
        ...
        if SI_unit is None:
            ...
            # as are VTK region locations
                ...
                SI_unit = 'm'
            # Densities - do this before ymax so we catch part_out_density_max
            ...
            # [xyz]max
                ...
                SI_unit = 'm'
            elif 'semiaxis' in desc_lower: # SQP
                SI_unit = 'm'
            # BC velocity keys
            ...
            # Coefficient of restitition is dimensionless
                ...
                SI_unit = 'coefficient'
            # Radii are meters
            elif 'radius' in desc_lower or 'diameter' in desc_lower:
                SI_unit = 'm'
            # Distances are too
