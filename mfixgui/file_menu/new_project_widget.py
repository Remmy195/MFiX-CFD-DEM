...
class NewProjectWidget(QWidget):
    def __init__(self, gui):
        ...
        self.solver_cbs = {"single": self.checkbox_single,
                           "tfm": self.checkbox_tfm,
                           "dem": self.checkbox_dem,
                           "cgp": self.checkbox_cgp,
                           "sqp": self.checkbox_sqp,
                           "gsp": self.checkbox_gsp,
        ...
        is_tile_mode = SETTINGS.value("open_list_mode", "list") in ("icon", "tile")
        if is_tile_mode:
    ...
    def populate_templates(self):
        ...
        # Nightmare code... somebody fix this please
        tuples = [
