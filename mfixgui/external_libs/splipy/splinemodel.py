...
class Orientation:
    ...
    *reference* system and the *actual* or *mapped* system.
    ...
    def view_section(self, section):
        ...
        that describes the same orientation, relative to the section only.

        For example, for a 2D orientation that flips only the second direction,
...
class NodeView:
    ...
    an orientation (:class:`splipy.SplineModel.Orientation`).
