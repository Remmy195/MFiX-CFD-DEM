...
class Curve(SplineObject):
    ...
    def evaluate(self, *params):
        ...
        N = self.bases[0].evaluate(params[0])
    ...
    def raise_order(self, amount, direction=None):
        ...
        self.controlpoints = np.array(linalg.solve(N_new, interpolation_pts_x))
        self.bases = [newBasis]
    ...
    def length(self, t0=None, t1=None):
        """ Computes the euclidean length of the curve in geometric space
    ...
    def rebuild(self, p, n):
        ...
        t = basis.greville()
        N = basis.evaluate(t)
        controlpoints = linalg.solve(N, self.evaluate(t))
