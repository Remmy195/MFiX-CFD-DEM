...
SINGLE, TFM, DEM, CGP, SQP, GSP, PIC, HYBRID = range(8)
SOLVERS = [SINGLE, TFM, DEM, CGP, SQP, GSP, PIC, HYBRID]
SOLIDS_MODELS = [None, 'TFM', 'DEM', 'CGP',
                 'SQP', 'GSP', 'PIC', 'TFM']

# Lock levels
UNLOCKED, PARTIAL_LOCK, LOCKED = 0, 1, 2

# model types
CONSTANT, AIR, UDF = 0, 1, 2
VARIABLE = MIXTURE = OTHER = IDEAL = SUTHERLAND = AIR  # continuum, etc
HERSCHEL_BULKLEY = 2
MULTICOMPONENT = 2
VISCOSITY_MODELS = ['CONSTANT', 'SUTHERLAND', 'HERSCHEL_BULKLEY',
                    'LENNARD_JONES', 'CANTERA_POLY', 'USR']
DIFFUSION_MODELS = ['CONSTANT', 'AIR', 'MULTICOMPONENT', 'UDF']
KG_MODELS = ['CONSTANT', 'AIR', 'LENNARD_JONES',
             'CANTERA_POLY', 'USR']
DRAG_TYPES = ['BVK',
              'DIFELICE',
              'DIFELICE_GANSER',
...
DEFAULT_DRAG_TYPE_SQP = 'SQP_DIFELICE_GANSER'
...
PARAMETER_DICT = dict([(key, 0.0) for key in SPECIAL_PARAMETERS])
