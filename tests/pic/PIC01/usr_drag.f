...
! Avinash Vaidheeswaran - 03/02/2020
! Hard coded ROg = 1.20 kg/m3.
! When fluid momentum equations are turned off using GUI,
! the density of fluid defaults to 0.0. For the terminal velocity case,
! we wish to have ROg = 1.20 kg/m3 to compare with the ODE solution.

      lDgA = 0.75*(1.20*VREL/DPM)*Cd(Re(VREL)) 
