...
contains
  ...
  subroutine monitor_area_avg(id, data, i_w, i_e, j_s, j_n, k_b, k_t)
    ...
    use monitor, only: monitor_type, monitor_var_count, monitor_geotype
  ...
  !                                                                    !
  !....................................................................!
  subroutine monitor_calc_area_avg(id,lc,liw,lie,ljs,ljn,lkb,lkt,&
    ...
    use monitor, only:  monitor_geotype
    ...
    if(liw == lie.and.monitor_geotype(id)=='YZ') then
       do k=klb, kub
          do i=ilb, iub
             do j=jlb, jub
                ijk = funijk(i,j,k)
    ...
    else if(ljs == ljn.and.monitor_geotype(id)=='XZ') then
       do k=klb, kub
          do i=ilb, iub
             do j=jlb, jub
                ijk = funijk(i,j,k)
    ...
    else if(lkb == lkt.and.monitor_geotype(id)=='XY') then
       do k=klb, kub
          do i=ilb, iub
             do j=jlb, jub
                ijk = funijk(i,j,k)
  ...
  !                                                                    !
  !....................................................................!
  subroutine monitor_calc_flow_rate(id, lc,liw,lie,ljs,ljn,lkb,lkt,&
       lvar, ep, ro, u, v, w, lvalue, lsize)
  ...
  !                                                                    !
  !....................................................................!
  subroutine monitor_calc_mass_avg(id, lc,liw,lie,ljs,ljn,lkb,lkt,&
       lvar, ep, ro, u, v, w, lvalue, lsize)
  ...
  !                                                                    !
  !....................................................................!
  subroutine monitor_calc_volflow_rate(id, lc,liw,lie,ljs,ljn,lkb,lkt,&
       lvar, ep, ro, u, v, w, lvalue, lsize)
