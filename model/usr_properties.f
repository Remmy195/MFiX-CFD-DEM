...
! Assign the fluid density
 ...
 9999 FORMAT('ERROR 9999: The user-defined properties routine was ',&
         'invoked for',/,A,' but this generic error',/,'message exists. ',&
         'Either choose a different model or correct',/,&
         'usr_properties.f')
      ENDIF
      RETURN
...
!    database or the input file. Species specific heats are needed by  !
...
!      the quantities Thigh(M,N), Tlow(M,N), Tcom, Alow(M,N) and       !
...
!    in that format from the input file. therefore inconsistencies     C
