...
! Indicates if the legacy reaction rates file (rrates.f) is used.
      LOGICAL :: USE_RRATES
! Indicates that reaction rates are saved in output arrays for vtk or monitor files
...
! Solids phase species names (database) and aliases
	 ...
	 ! RxnOrder of each species
	 DOUBLE PRECISION RxnOrder
      END TYPE SPECIES_
