...
! Minimum reaction rate. If all fluid reaction rates are below this threshold, a
! cell is said to be non-reactive and no ODE is set for this cell.
  double precision :: stiff_chem_min_rate

! Minimum dpm reaction rate. If all dpm reaction rates are below this threshold, a
! particle is said to be non-reactive and no ODE is set for this particle.
  double precision :: stiff_chem_min_rate_dpm

! Minimum species mass fraction in fluid. Reaction rates are not calculated
! when reactants fall below this limiter.
  double precision :: chem_min_species_fluid

! Minimum species mass fraction in solid. Reaction rates are not calculated
! when reactants fall below this limiter.
  double precision :: chem_min_species_solid

! Threshold of particle mass percentage to be considered in the reactions.
! It is defined as the ratio of the minimum considered mass to its initial mass.
! When the ratio of particle mass to its initial mass is lower than this threshold, the reactions
! which consumes the particles will be turned off.
  double precision :: DES_MIN_PMASS_FRAC
