...
! file unit for compact output
      INTEGER, PARAMETER :: UNIT_LOG1 = 56
      CONTAINS
...
! looping variable
      ...
      INTEGER FUNCTION FILE_SIZE(FILENAME)
         ...
         INTEGER :: SIZE
         INTEGER :: IOS
         OPEN(UNIT=UNIT_DAT, FILE=FILENAME, FORM="UNFORMATTED", ACCESS="STREAM", ACTION="READ", IOSTAT=IOS)
         IF (IOS /= 0) THEN
             FILE_SIZE = 0
         ELSE
