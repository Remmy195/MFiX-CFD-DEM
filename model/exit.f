MODULE exit
   ...
   use funits, only: dmp_log, unit_out, unit_log, unit_log1
...
#if defined(PYMFIX) || !defined(QUIET)
...
#endif
      ! CHECK_EXIT_FLAG = (EXIT_FLAG.OR.monitor_ss_exit)
