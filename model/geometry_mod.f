...
! Cell sizes in the x or r direction
      DOUBLE PRECISION :: DX (0:DIM_I+2)
! Cell sizes in the y direction
      DOUBLE PRECISION :: DY (0:DIM_J+2)
! Cell sizes in the z or theta direction
      DOUBLE PRECISION :: DZ (0:DIM_K+2)
...
! Coordinates of scalar cell center
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: CENTER_S
