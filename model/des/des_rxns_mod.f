...
! Indicates that reaction rates are saved in output arrays for vtp or monitor files
...
! It is used to check if the particle mass is smaller than the specified threshold
! for turnning off the reactions. When particle mass is smaller than
! DES_MIN_PMASS_FRAC*DES_MIN_PMASS, the reactions are turned off for this particle.
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: DES_MIN_PMASS
