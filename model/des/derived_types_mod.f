...
! drag_c1 and drag_d1 accordingly)
  ...
  ENUM, BIND(C)
     ...
     ENUMERATOR :: SQP_DIFELICE_GANSER=19
     ENUMERATOR :: SQP_DIFELICE_HOLZER_SOMMERFELD=20
...
! Gas viscosity model options (see calc_mu_g for details)
! Gas viscosity model
  CHARACTER(len=64) :: MU_G_MODEL
  INTEGER :: MU_G_MODEL_ENUM
  ENUM, BIND(C)
     ENUMERATOR :: MU_G_CONSTANT=0
     ENUMERATOR :: MU_G_USR=1
     ENUMERATOR :: MU_G_SUTHERLAND=2
     ENUMERATOR :: MU_G_HERSCHEL_BULKLEY=3
     ENUMERATOR :: MU_G_LENNARD_JONES=4
     ENUMERATOR :: MU_G_CANTERA_POLY=5
  END ENUM

! Gas thermal conductivity model options (see calc_k_g for details)
! Gas thermal conductivity model
  CHARACTER(len=64) :: KG_MODEL
  INTEGER :: KG_MODEL_ENUM
  ENUM, BIND(C)
     ENUMERATOR :: KG_CONSTANT=0
     ENUMERATOR :: KG_USR=1
     ENUMERATOR :: KG_AIR=2
     ENUMERATOR :: KG_LENNARD_JONES=3
     ENUMERATOR :: KG_CANTERA_POLY=4
  END ENUM
