...
! wall time at start
      DOUBLE PRECISION :: DIFFUSE_START_TIME
...
!......................................................................!
      ...
      IF(setDBG) THEN
         ...
         diffuse_start_time = get_elapsed_time()
      ENDIF
...
! Debugging information
      IF(setDBG) THEN
         WRITE(ERR_MSG, 9001) get_elapsed_time() - diffuse_start_time
         CALL LOG_MESSAGE(__FILE__, __LINE__, LOGLEVEL_INFO, HEADER=.FALSE., FOOTER=.FALSE.)
      ENDIF

      DEALLOCATE(DIF)

9001  FORMAT(5x,'Diffusion took ',g11.4,'s')
