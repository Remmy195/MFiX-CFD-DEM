...
! Gas phase pressure
      ...
      use discretelement, only: MAX_PIP, PIJK, DES_EXPLICITLY_COUPLED,rk_global_cnt_debug
...
!$omp shared(MAX_PIP,DES_INTERP_ON,LP_BND,p_force, &
!$omp filter_cell,filter_weight,pijk,pvol,drag_fc)
         DO NP=1,MAX_PIP
