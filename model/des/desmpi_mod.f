...
! variables used to read initial particle properties
      ...
      double precision, dimension(:,:), allocatable:: dpar_var
...
!SuperDEM
      double precision, dimension(:,:), allocatable:: dpar_super_r
      double precision, dimension(:,:), allocatable:: dpar_super_mn
      double precision, dimension(:,:), allocatable:: dpar_super_q
...
!-----------------------------------------------
      ...
      case (4)
          ...
          do lcurpar=1,max_pip
             ...
             any_ghost = (is_any_ghost(lcurpar))
...
! print neighbour information
      ...
      case (6)
         ...
         write(44,*) "Total particles =",pip
         write(44,*) "Total ghost particles =",ighost_cnt
