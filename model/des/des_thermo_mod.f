...
! Calculate the specific heat from polynomial data obtained from the
...
! Number of species comprising species
      ...
      use discretelement, only: PIJK, GluedSphereDEM
...
! The dataset already provide SI unit, do we need this anymore? renjieke 2-13-2024
