...
!---------------------------------------------------------------------//
   ...
   PUBLIC :: IS_RIGID_MOTION, IS_RIGID_MOTION_GHOST
   PUBLIC :: IS_GHOST, IS_ENTERING_GHOST, IS_EXITING_GHOST
   PUBLIC :: IS_ANY_GHOST
   PUBLIC :: SET_NONEXISTENT, SET_NORMAL, SET_ENTERING, SET_EXITING
   PUBLIC :: SET_RIGID_MOTION, SET_RIGID_MOTION_GHOST
   PUBLIC :: SET_GHOST, SET_ENTERING_GHOST, SET_EXITING_GHOST
   PUBLIC :: SET_NONEXISTENT_GSP, SET_NORMAL_GSP, SET_ENTERING_GSP, SET_EXITING_GSP
