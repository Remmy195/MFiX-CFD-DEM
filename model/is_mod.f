...
! Wall translational velocity for a moving internal surface (DES)
      DOUBLE PRECISION :: IS_WALL_VEL (DIMENSION_IS, 3)

! Wall rotational velocity for a moving internal surface (DES)
      DOUBLE PRECISION :: IS_WALL_OMEGA (DIMENSION_IS, 3)

! Wall center of rotation for a moving internal surface (DES)
      DOUBLE PRECISION :: IS_WALL_ROT_CENTER (DIMENSION_IS, 3)

! Keep track of current translation and rotation
      DOUBLE PRECISION :: IS_WALL_TRANSLATION (DIMENSION_IS, 3)
      DOUBLE PRECISION :: IS_WALL_ANGLE (DIMENSION_IS, 3)

     INTEGER :: IS_REBIN_N=10, IS_BIN_COUNT=0
