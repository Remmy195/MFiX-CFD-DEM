...
!                      Apply default wall BC along the edges of the MFiX box
!                      (no-slip, adiabatic wall)
      LOGICAL          BC_DEFAULT_WALLS
!
...
! Moving wall. Only supported with DEM,CGP, SQP, GSP models
! This is meant to be used to apply a tangential component
! along a wall, either in terms of a translational
! velocity (BC_Wall_Vel) or rotation about BC_Wall_Rot_Center, with angular velocity
! BC_Wall_Omega

! Wall translational velocity
      DOUBLE PRECISION BC_Wall_Vel (DIMENSION_BC,3)

! Wall rotational velocity
      DOUBLE PRECISION BC_Wall_Omega (DIMENSION_BC,3)

! Wall center of rotation
      DOUBLE PRECISION BC_Wall_Rot_Center (DIMENSION_BC,3)
...
!
!                      Flag to know if a jet BC is defined
      LOGICAL          BC_JET(DIMENSION_BC)
...
!
!                      Specified mass flux (e.g., kg/m^2.s) in the cyclic
...
! Flag to randomize sqp orientation (quaternion) at mass inlet BC
      LOGICAL:: BC_SQP_RANDOM_Q (DIMENSION_BC, DIM_M)

! Flag to randomize gsp orientation (quaternion) at mass inlet BC
      LOGICAL:: BC_GSP_RANDOM_Q (DIMENSION_BC, DIM_M)



! BC ramp
! currently only supported for Mass inlet BCs
! For each BC parameter, the user can supply values at the start and end of the
! ramp (*ramp_v0, *ramp_v1 values), along with the duration of the ramp (*ramp_t0)

      LOGICAL:: BC_RAMP(DIMENSION_BC)

! Gas pressure
      DOUBLE PRECISION:: BC_P_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_P_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_P_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_P_g_ramp_v1 (DIMENSION_BC)
!

! Gas phase temperature
      DOUBLE PRECISION:: BC_T_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_T_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_T_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_T_g_ramp_v1 (DIMENSION_BC)
!
! Solids phase temperature
      DOUBLE PRECISION:: BC_T_s_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_T_s_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_T_s_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_T_s_ramp_v1 (DIMENSION_BC, DIM_M)
!
! Solids phase granular temperature
      DOUBLE PRECISION:: BC_Theta_m_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_Theta_m_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_Theta_m_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_Theta_m_ramp_v1 (DIMENSION_BC, DIM_M)
!
! x-component of gas velocity
      DOUBLE PRECISION:: BC_U_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_U_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_U_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_U_g_ramp_v1 (DIMENSION_BC)
!
! x-component of solids phase velocity
      DOUBLE PRECISION:: BC_U_s_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_U_s_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_U_s_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_U_s_ramp_v1 (DIMENSION_BC, DIM_M)
!
! y-component of gas velocity
      DOUBLE PRECISION:: BC_V_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_V_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_V_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_V_g_ramp_v1 (DIMENSION_BC)
!
! y-component of solids phase velocity
      DOUBLE PRECISION:: BC_V_s_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_V_s_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_V_s_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_V_s_ramp_v1 (DIMENSION_BC, DIM_M)
!
! z-component of gas velocity
      DOUBLE PRECISION:: BC_W_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_W_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_W_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_W_g_ramp_v1 (DIMENSION_BC)
!
! z-component of solids phase velocity
      DOUBLE PRECISION:: BC_W_s_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_W_s_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_W_s_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_W_s_ramp_v1 (DIMENSION_BC, DIM_M)
!

! Gas volumetric flow rate
      DOUBLE PRECISION:: BC_VOLFLOW_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_VOLFLOW_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_VOLFLOW_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_VOLFLOW_g_ramp_v1 (DIMENSION_BC)
!
! Solids volumetric flow rate
      DOUBLE PRECISION:: BC_VOLFLOW_s_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_VOLFLOW_s_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_VOLFLOW_s_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_VOLFLOW_s_ramp_v1 (DIMENSION_BC, DIM_M)
!
! Gas mass flow rate
      DOUBLE PRECISION:: BC_MASSFLOW_g_ramp_t0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_MASSFLOW_g_ramp_t1 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_MASSFLOW_g_ramp_v0 (DIMENSION_BC)
      DOUBLE PRECISION:: BC_MASSFLOW_g_ramp_v1 (DIMENSION_BC)
!
! Solids mass flow rate
      DOUBLE PRECISION:: BC_MASSFLOW_s_ramp_t0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_MASSFLOW_s_ramp_t1 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_MASSFLOW_s_ramp_v0 (DIMENSION_BC, DIM_M)
      DOUBLE PRECISION:: BC_MASSFLOW_s_ramp_v1 (DIMENSION_BC, DIM_M)
