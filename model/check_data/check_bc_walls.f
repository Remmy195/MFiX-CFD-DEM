...
! Input checks for solid phases.
      DO M=1, MTOT_L
         ...
         CASE ('DEM', 'CGP','SQP', 'PIC', 'GSP'); CALL CHECK_BC_WALLS_DISCRETE(BCV, M)
         END SELECT
      ENDDO
...
! to estimate the phi at r->0
 ...
 1201 FORMAT('Error 1201: KT_TYPE = "GHD" cannot be used with BC_JJ_PS.')

 1202 FORMAT('Error 1202: CARTESIAN_GRID cannot be used with BC_JJ_PS.')

 1203 FORMAT('Error 1203: JENKINS and BC_JJ_M cannot be used at the same time.')

 1204 FORMAT('Error 1204: Angle of particle-wall friction (PHI_W) not specified')

 1208 FORMAT('Error 1208: phip0 less than zero.')
 1209 FORMAT('Error 1209: nRR should be at least 1 for storing specularity.')
...
! Poorly defined wall BC.
 ...
 1100 FORMAT('Error 1100: The energy equation boundary condition ',i3,&
      ' is ill-defined for solids ',I2,/,'. Walls can be adiabatic or have a',&
      'specified temperature for DEM.')
...
! DEM cannot have a species flux at the walls.
 ...
 1101 FORMAT('Error 1101: Invalid input for boundary condition: ',I3,/ &
