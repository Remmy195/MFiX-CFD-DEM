...
! Check mass flow and velocity
 ...
 1100 FORMAT('Error 1100: Invalid specification for point source ',I3,&
         '.',/A,' is undefined but velocity is given.')
...
! Enforce that the species mass fractions must sum to one.
 ...
 1110 FORMAT('Error 1110: PS_X_g(',I3,',:) do not sum to 1 and the ',&
 ...
 1111 FORMAT('Error 1111: PS_X_g(',I3,',:) do not sum to 1 or 0 and they',/&
             'are not needed.')
...
! Enforce that the species mass fractions must sum to one.
 ...
 1120 FORMAT('Error 1120: PS_X_s(',I3,',',I2,',:) do not sum to 1 ', &
 ...
 1121 FORMAT('Error 1121: PS_X_s(',I3,',',I2,',:) do not sum to 1 ', &
