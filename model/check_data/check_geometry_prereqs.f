...
! that direction should be 1
 ...
 1100 FORMAT('Error 1100: Illegal geometry: NO_',A1,' is disabled. ',  &
         ...
         'MAX=1) and making the ',A,' walls',/'free-slip.')
 ...
 1101 FORMAT('Error 1101: Illegal geometry: ',A,' cannot be less than 0')
 ...
 1102 FORMAT('Error 1102: X-axis cannot be CYCLIC in cylindrical coordinates.')
 ...
 1103 FORMAT('Error 1103: Unknown COORDINATES specified.')
 ...
 1110 FORMAT('Error 1110: Illegal geometry: ',A,' must remain ',       &
         'UNDEFINED_I or 1 when',/A,' is TRUE.')
