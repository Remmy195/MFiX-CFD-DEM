...
!     Maximum number of facets, set in get_stl_facets_count
      INTEGER          :: DIM_STL
!     Number of facets
      INTEGER                     :: N_FACETS
...
!     Face normal vector (normalized)
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: NORM_FACE
!     Face normal velocity (moving geometry)
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: STL_NORMAL_VEL
!     Face tangential velocity (moving geometry)
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: STL_TANGENTIAL_VEL
!     Flag to identify facets that are located along the MFiX domain box
      LOGICAL, DIMENSION(:), ALLOCATABLE :: STL_FACET_ALONG_BOX
...
! particles and the facets common edge will be ignored
      DOUBLE PRECISION :: STL_NB_ANGLE
...
! ID
         INTEGER :: ID
! ID of the corresponding BC
         INTEGER :: BC_ID
! ID of the corresponding IS
         INTEGER :: IS_ID
...
! STL data
!     Particle collision counter
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: STL_COLLISION_COUNT
!     Wear, normal direction
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: STL_WEAR_N
!     Collision force with STL, normal direction
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: STL_FNORM
!     Collision force with STL, tangential direction
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: STL_FTAN
