...
! Flag to abort if unsuccessful seeding occurs
      LOGICAL :: IC_DES_ABORT_ON_FAILED_SEEDING (DIMENSION_IC, DIM_M)
...
! Random initial sqp quaternion
      LOGICAL :: IC_SQP_RANDOM_Q(DIMENSION_IC, DIM_M)

! Random initial gsp quaternion
      LOGICAL :: IC_GSP_RANDOM_Q(DIMENSION_IC, DIM_M)
      LOGICAL :: IC_OVERRIDE_PART_INPUT(DIMENSION_IC, DIM_M)
